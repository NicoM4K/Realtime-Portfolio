...
import {positionLocal, time, vec2, checker,uv,float, vec3, sin, vec4} from 'three/tsl'
 ...
 */
{
    ...
    material.colorNode = vec3(1,0.4,0.4)
    material.roughnessNode = float(0)
    
    const zoffset = sin(time.add(positionLocal.y.mul(0.3))).mul(0.5).add(0.4)
